...
export const ICONS = {
  ...
  // This machine, as opposed to `server` — the pair carries the local/remote
  // distinction wherever a session is listed.
  laptop: '<path d="M5 6.5a1.5 1.5 0 0 1 1.5-1.5h11A1.5 1.5 0 0 1 19 6.5V15H5z"/><path d="M2.5 15h19l-1 2.6a1.5 1.5 0 0 1-1.4 0.9H4.9a1.5 1.5 0 0 1-1.4-0.9z"/>',
} as const;
